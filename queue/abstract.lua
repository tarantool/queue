...
function method.start()
    ...
    if _queue == nil then
        ...
        _queue:create_index('tube_id',
            { type = 'tree', parts = { 2, num.get_num_or_unsigned(box.info.version) }, unique = true })
    end
    ...
    if _cons == nil then
        ...
        _cons:create_index('pk',
            { type = 'tree', parts = { 1, num.get_num_or_unsigned(box.info.version), 2, num.get_num_or_unsigned(box.info.version) }, unique = true })
        _cons:create_index('consumer',
            { type = 'tree', parts = { 3, num.get_num_or_unsigned(box.info.version), 4, num.get_num_or_unsigned(box.info.version) }, unique = false})
    end
    ...
    if _taken == nil then
        ...
        _taken:create_index('pk',
            { type = 'tree', parts = { 1, num.get_num_or_unsigned(box.info.version), 2, num.get_num_or_unsigned(box.info.version), 3, num.get_num_or_unsigned(box.info.version)}, unique = true})

        _taken:create_index('task',
            { type = 'tree', parts = { 2, num.get_num_or_unsigned(box.info.version), 3, num.get_num_or_unsigned(box.info.version) }, unique = true })
    end
